...
{   
    ...
    Vector3f v1p = Vector3f(x, y, 0) - v1;
    Vector3f v2p = Vector3f(x, y, 0) - v2;
    Vector3f v3p = Vector3f(x, y, 0) - v3;

    float c1 = v1v2.cross(v1p).z();
    float c2 = v2v3.cross(v2p).z();
    float c3 = v3v1.cross(v3p).z();
